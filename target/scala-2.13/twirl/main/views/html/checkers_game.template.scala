...
<div class="gamecontainer">
  <div class="game">
    ...
    """),format.raw/*60.5*/("""<div class="fieldrow"> <!--Maybe think of a different name, might not make sense?-->
      ...
      """),format.raw/*63.7*/("""<span class="field_red" id="field_red">
      ...
      """),format.raw/*81.7*/("""<span class="field_black" id="field_black"></span> <!-- If the code breaks, just copy from above-->
      """)))}),format.raw/*82.8*/("""
      """)))}),format.raw/*83.8*/("""
    """),format.raw/*84.5*/("""</div>
...
<script>
  function openGrid(nmbr) """),format.raw/*105.27*/("""{"""),format.raw/*105.28*/("""
    """),format.raw/*106.5*/("""if (confirm("Are you sure you want to continue? Starting a new game means that current progress will be lost!")) """),format.raw/*106.118*/("""{"""),format.raw/*106.119*/("""
      """),format.raw/*107.7*/("""window.location.href="http://localhost:9000/new"+nmbr+"Grid";
    """),format.raw/*108.5*/("""}"""),format.raw/*108.6*/("""
  """),format.raw/*109.3*/("""}"""),format.raw/*109.4*/("""
  """),format.raw/*110.3*/("""function move() """),format.raw/*110.19*/("""{"""),format.raw/*110.20*/("""
    """),format.raw/*111.5*/("""var x = document.getElementById("text-input").value;
    if (x === "") """),format.raw/*112.19*/("""{"""),format.raw/*112.20*/("""
      """),format.raw/*113.7*/("""alert("Input can't be empty");
      return;
    """),format.raw/*115.5*/("""}"""),format.raw/*115.6*/("""
    """),format.raw/*116.5*/("""var start = x.split(" ")[0];
    var dest = x.split(" ")[1];
    location.href = "http://localhost:9000/move/" + start + "/" + dest;
  """),format.raw/*119.3*/("""}"""),format.raw/*119.4*/("""

"""),format.raw/*121.1*/("""</script>"""))
      }
    }
  }
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: 2022-11-30T16:06:32.497
                  SOURCE: /Users/ginakokoska/IdeaProjects/HTWG/AIN5/Webapplikation/checkers_wa/app/views/checkers_game.scala.html
                  HASH: 964b6b1044b367a4478d18c1f667461adbfa30bd
                  MATRIX: 797->1|963->92|974->96|1033->90|1061->125|1089->127|1313->324|1328->330|1385->366|1771->725|1786->731|1847->771|4295->3193|4335->3217|4375->3219|4407->3224|4525->3316|4565->3340|4605->3342|4639->3350|4670->3372|4710->3374|4744->3381|4826->3436|4871->3472|4911->3474|4956->3492|5028->3555|5068->3557|5115->3576|5156->3590|5192->3605|5243->3629|5301->3666|5348->3685|5392->3711|5405->3716|5444->3717|5491->3736|5532->3750|5568->3765|5619->3789|5677->3826|5724->3845|5780->3870|5815->3887|5828->3892|5867->3893|5912->3910|5953->3924|6003->3953|6052->3975|6078->3980|6123->3997|6177->4020|6218->4033|6251->4049|6264->4054|6303->4055|6337->4062|6474->4169|6512->4177|6544->4182|6641->4249|6671->4252|7081->4635|7111->4644|7140->4645|7230->4706|7260->4707|7293->4712|7436->4825|7467->4826|7502->4833|7596->4899|7625->4900|7656->4903|7685->4904|7716->4907|7761->4923|7791->4924|7824->4929|7924->5000|7954->5001|7989->5008|8066->5057|8095->5058|8128->5063|8291->5198|8320->5199|8350->5201
                  LINES: 21->1|25->3|25->3|26->2|27->3|29->5|34->10|34->10|34->10|37->13|37->13|37->13|83->59|83->59|83->59|84->60|85->61|85->61|85->61|86->62|86->62|86->62|87->63|88->64|88->64|88->64|89->65|89->65|89->65|90->66|90->66|90->66|91->67|91->67|92->68|93->69|93->69|93->69|94->70|94->70|94->70|95->71|95->71|96->72|97->73|98->74|98->74|98->74|99->75|99->75|99->75|100->76|100->76|101->77|102->78|103->79|104->80|104->80|104->80|105->81|106->82|107->83|108->84|110->86|111->87|119->95|119->95|119->95|129->105|129->105|130->106|130->106|130->106|131->107|132->108|132->108|133->109|133->109|134->110|134->110|134->110|135->111|136->112|136->112|137->113|139->115|139->115|140->116|143->119|143->119|145->121
                  -- GENERATED --
              */
